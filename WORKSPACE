...
load("//tools/workspace:ceres.bzl", "ceres_repository")
load("//tools/workspace:colmap.bzl", "colmap_repository")
load("//tools/workspace:freeimage.bzl", "freeimage_repository")
load("//tools/workspace:curl.bzl", "curl_repository")
load("//tools/workspace:openssl.bzl", "openssl_repository")
load("//tools/workspace:pcl.bzl", "pcl_repository")
# load("//tools/workspace:gsplat.bzl", "gsplat_repository")
