...
public:
    ...
    static torch::Tensor computeL1Loss(const torch::Tensor& rendered, const torch::Tensor& ground_truth);
    
    // D-SSIM loss computation
    static torch::Tensor computeD_SSIMLoss(const torch::Tensor& rendered, const torch::Tensor& ground_truth);
